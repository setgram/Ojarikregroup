      ...
      <div className="flex mx-auto items-center justify-between max-w-6xl">
        ...
        <div className="flex mt-2 mb-2">
          <input
            ...
            className="bg-slate-600 w-96 py-1 px-1 flex-grow text-white outline-none"
          />
          <button className="bg-yellow-600 px-10 py-2 cursor-pointer">
            <IoSearch />{" "}
          </button>
        </div>
        <p className="text-slate-900 gap-3 flex items-center">
          <CiMail /> elvisojas22@gmail.com <LuPhone />
